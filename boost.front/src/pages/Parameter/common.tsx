...
export const initialPaymentKeysNameList = {
    ...
    wechatPay: ['WechatPayAppId', 'WechatPayMchId', 'WechatPayApiV3Key', 'WechatPayMchSerialNo', 'WechatPayGateway', 'WechatPayPrivateKeyPath'],
};
...
export const encryptedCredentialsMap = {
    ...
    'WechatPayMchId': false,
    'WechatPayApiV3Key': true,
    'WechatPayMchSerialNo': true,
    'WechatPayGateway': false,
    'WechatPayPrivateKeyPath': true,
};
...
>> = ({ name, label, payChannel, storageMethod, editing, uploadedCertName, handlePaymentKeysChange }) => {
        ...
        reader.onload = async () => {
            try {
                ...
                const response = await putCert({payChannel: payChannel as PayChannelType,
                    certName: certName, certContent: certContent, storageMethod: storageMethod});
